...
/***/ function(module, exports, __webpack_require__) {
	...
	if (_react2['default'].initializeTouchEvents) _react2['default'].initializeTouchEvents(true);

	var Screen = _react2['default'].createClass({
	    displayName: 'Screen',
	...
	var MoveController = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            'div',
	            { className: 'MoveController', onTouchStart: this._touchStart, onTouchEnd: this._touchEnd,
	                onTouchMove: this._touchMove, ref: 'ctrl' },
	            _react2['default'].createElement('span', { className: 'MoveController__move', ref: 'move', style: style })
	        );
	    },
	    ...
	    getDirection: function getDirection(diff) {
	        if (diff[0] < 0) {
	    ...
	    setToCenter: function setToCenter() {
	        this.setState({
	...
	var gameStore = {
	    ...
	    actions: {
	        moveAction: function moveAction(action, slot) {},
	    ...
	    publish: function publish() {
	        this.cbs.forEach(function (f) {
	            f();
	        });
	    }
	};

	_react2['default'].render(_react2['default'].createElement(Screen, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./game.styl", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./game.styl");
